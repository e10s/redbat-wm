...
class CursorManager
{
    ...
    this(Window root)
    {
        ...
        foreach (i, style; styles)
        {
            ...
            xcb_create_glyph_cursor(root.connection, cid, font, font, style, cast(ushort)(style + 1), 0, 0, ushort.max,
    ...
    ~this()
    {
        foreach (e; cursor.byValue)
        {
            xcb_free_cursor(root.connection, e);
        }
    }
...
private enum FontCursor : ushort
{
    XC_X_cursor = 0,
    XC_arrow = 2,
